...
<div id="wrap">
	...
	<script type="text/javascript">
		...
		links += "${pageContext.request.contextPath}/indexRkjsAction!findXinWen2ForShow?xinwenID=${tpxw0ID }";
		texts += "${tpxw0Title}";
		...
		links += "${pageContext.request.contextPath}/indexRkjsAction!findXinWen2ForShow?xinwenID=${tpxw1ID }";
		texts += "${tpxw1Title}";
		...
		links += "${pageContext.request.contextPath}/indexRkjsAction!findXinWen2ForShow?xinwenID=${tpxw2ID }";
		texts += "${tpxw2Title}";
		...
		document.write('</object>');
				...
				<div class="index_L_yaowen">
					<div class="title1"><a href="${pageContext.request.contextPath}/indexRkjsAction!queryXinWen0Menu">
					...
					<ul class="yaowen_list">
						...
						<li>
							...
							·<a href="${pageContext.request.contextPath}/indexRkjsAction!findXinWen0ForShow?xinwenID=${xw.xinwenID }">
			...
			<div id="index_L_2">
				<div class="index_L_ry">
					<div class="title2"><a href="${pageContext.request.contextPath}/indexRkjsAction!queryWjfbMenu">
					<img src="${pageContext.request.contextPath}/resource/images/more.jpg" /></a>文件发布</div>
					<ul class="wenjian">
					<s:iterator value="wjfb0" var="wj" >
						<li>·<a href="${pageContext.request.contextPath}/indexRkjsAction!findWjfbForShow?wjfbID=${wj.wjfbID }">
				...
				<div class="index_L_zc1">
					<div class="title1"><a href="${pageContext.request.contextPath}/indexRkjsAction!queryZcfgMenu">
					<img src="${pageContext.request.contextPath}/resource/images/more.jpg" /></a>政策法规</div>
					<ul>
						<s:iterator value="zcfg0" var="zc">
							<li>·<a href="${pageContext.request.contextPath}/indexRkjsAction!findZcfgForShow?zcfgID=${zc.zcfgID }">
		...
		<div id="index_R">
			<div class="index_R_1">
				<div class="title4"><a href="${pageContext.request.contextPath}/indexRkjsAction!queryTzggMenu">
				<img src="${pageContext.request.contextPath}/resource/images/more2.jpg" /></a>通知公告</div>
				<ul>
					<s:iterator value="tzgg0" var="tz" >
						<li>·<a href="${pageContext.request.contextPath}/indexRkjsAction!findTzggForShow?tzggID=${tz.tzggID }">
			...
			<div class="index_R_1" style="margin-top:14px;">
				<div class="title4"><a href="${pageContext.request.contextPath}/indexRkjsAction!queryZnbmMenu">
					<img src="${pageContext.request.contextPath}/resource/images/more2.jpg" /></a>职能部门</div>
				<ul class="zhineng">
					<li><a href="${pageContext.request.contextPath}/indexRkjsAction!findZnbmForShow?type=0">办公室职能</a></li>
					<li><a href="${pageContext.request.contextPath}/indexRkjsAction!findZnbmForShow?type=1">业务科职能</a></li>
					<li><a href="${pageContext.request.contextPath}/indexRkjsAction!findZnbmForShow?type=2">服务站职能</a></li>
				</ul>
			</div>	
		</div>
	</div>
	<p class="c"></p>
	<div class="tl"><img src="${pageContext.request.contextPath}/resource/images/renkou_tl.jpg" width="1000" height="93" /></div>
	<div class="renkou">
		<div id="renkou_L">
			<div class="index_L_ry">
				<div class="title2"><a href="${pageContext.request.contextPath}/indexRkjsAction!queryBsznMenu">
				...
				<div class="renkou_L_b">
					...
					<s:iterator value="bszn0" var="bs" >
						<li>·<a href="${pageContext.request.contextPath}/indexRkjsAction!findBsznForShow?bsznID=${bs.bsznID }">
			...
			<div class="renkou_M">
				<div class="title1"><a href="${pageContext.request.contextPath}/indexRkjsAction!queryRdgzMenu">
				<img src="${pageContext.request.contextPath}/resource/images/more.jpg" /></a>热点关注</div>
				<ul>
					<s:iterator value="rdgz0" var="rd" >
						<li>·<a href="${pageContext.request.contextPath}/indexRkjsAction!findRdgzForShow?rdgzID=${rd.rdgzID }">
			...
			<div class="renkou_R">
				<div class="title4"><a href="${pageContext.request.contextPath}/indexRkjsAction!queryLxfsMenu">
