 	...
 	$(document).ready(function() {
		$("#uploadFile").uploadify({
			...
			'cancelImg' : 'uploadify/uploadify-cancel.png',//取消的X
			 'uploader'      : '${pageContext.request.contextPath}/xzzqAction!fileUpload',//后台处理的请求
			'method' : 'POST',
			...
			'fileTypeExts': '*.xlsx;*.pptx;*.docx;*.xls;*.ppt;*.doc;*.pdf',//允许的格式
			'fileTypeDesc': '支持格式:xlsx/pptx/docx/xls/ppt/doc/pdf', //如果配置了以下的'fileExt'属性，那么这个属性是必须的  
