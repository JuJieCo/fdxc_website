...
<div id="wrap">
	...
	<form action="${pageContext.request.contextPath}/indexYlwsAction!queryTzggMenu" name="form1"  method="post" ></form>
		...
		<div id="sub_R">
			...
			<div class="news">
				<ul>
					...
					<li><span>[${list.subDate}]</span><a href="${pageContext.request.contextPath}/indexYlwsAction!findTzggForShow?tzggID=${list.tzggID}">・${list.tzggTitle}</a></li>
					</c:if>
					</s:iterator>
				</ul>
				<p class="c"></p>
