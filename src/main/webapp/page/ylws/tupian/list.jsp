...
<div id="wrap">
	...
	<form action="${pageContext.request.contextPath}/indexYlwsAction!queryXinWen0Menu" name="form1"  method="post" ></form>
	...
	<div id="index">
		...
		<div id="sub_R">
			<div class="title5">当前位置 > 医疗卫生 > 图片新闻</div>
			<div class="news">
				<ul>
					<s:iterator value="xinwenList" var="list">
					<c:if test="${list.xinwenTitle ne null }">
					<li><span>[${list.subDate}]</span><a href="${pageContext.request.contextPath}/indexYlwsAction!findXinWen0ForShow?xinwenID=${list.xinwenID }">・${list.xinwenTitle}</a></li>
					</c:if>
					</s:iterator>
				</ul>
				<p class="c"></p>
