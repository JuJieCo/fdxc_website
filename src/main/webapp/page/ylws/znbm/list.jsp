...
<div id="wrap">
	...
	<form action="${pageContext.request.contextPath}/indexYlwsAction!queryWjfbMenu" name="form1"  method="post" ></form>
	...
	<div id="index">
		...
		<div id="sub_R">
			<div class="title5">当前位置 > 医疗卫生 > 职能部门</div>
			<div class="news">
				<ul>
					
					<li><span>[${znbm.subDate}]</span><a href="${pageContext.request.contextPath}/indexYlwsAction!findZnbmForShow?type=0">・办公室职能</a></li>
					<li><span>[${znbm.subDate}]</span><a href="${pageContext.request.contextPath}/indexYlwsAction!findZnbmForShow?type=1">・业务科职能</a></li>
					<li><span>[${znbm.subDate}]</span><a href="${pageContext.request.contextPath}/indexYlwsAction!findZnbmForShow?type=2">・服务站职能</a></li>
