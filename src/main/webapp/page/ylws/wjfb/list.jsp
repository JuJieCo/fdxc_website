...
<div id="wrap">
	...
	<div id="index">
		...
		<div id="sub_R">
			<div class="title5">当前位置 > 医疗卫生 > 文件发布</div>
			<div class="news">
				<ul>
					<s:iterator value="wjfbList" var="list">
					<c:if test="${list.wjfbTitle ne null }">
					<li><span>[${list.subDate}]</span><a href="${pageContext.request.contextPath}/indexYlwsAction!findWjfbForShow?wjfbID=${list.wjfbID}">・${list.wjfbTitle}</a></li>
					</c:if>
					</s:iterator>
				</ul>
				<p class="c"></p>
