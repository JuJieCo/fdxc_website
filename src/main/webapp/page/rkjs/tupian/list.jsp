...
<div id="wrap">
	...
	<form action="${pageContext.request.contextPath}/indexRkjsAction!queryXinWen0Menu" name="form1"  method="post" ></form>
	...
	<div id="index">
		...
		<div id="sub_R">
			<div class="title5">当前位置 > 人口计生 > 图片新闻</div>
			<div class="news">
				<ul>
					<s:iterator value="xinwenList" var="list">
					<c:if test="${list.xinwenTitle ne null }">
					<li><span>[${list.subDate}]</span><a href="${pageContext.request.contextPath}/indexRkjsAction!findXinWen0ForShow?xinwenID=${list.xinwenID }">・${list.xinwenTitle}</a></li>
					</c:if>
					</s:iterator>
				</ul>
				<p class="c"></p>
