...
<div id="wrap">
	...
	<form action="${pageContext.request.contextPath}/indexRkjsAction!queryZcfgMenu" name="form1"  method="post" ></form>
	...
	<div id="index">
		...
		<div id="sub_R">
			<div class="title5">当前位置 > 人口计生 > 政策法规</div>
			<div class="news">
				<ul>
					<s:iterator value="zcfgList" var="list">
					<c:if test="${list.zcfgTitle ne null }">
					<li><span>[${list.subDate}]</span><a href="${pageContext.request.contextPath}/indexRkjsAction!findZcfgForShow?zcfgID=${list.zcfgID}">・${list.zcfgTitle}</a></li>
					</c:if>
					</s:iterator>
				</ul>
				<p class="c"></p>
