...
<div id="wrap">
	...
	<form action="${pageContext.request.contextPath}/indexRkjsAction!queryWjfbMenu" name="form1"  method="post" ></form>
	...
	<div id="index">
		...
		<div id="sub_R">
			<div class="title5">当前位置 > 人口计生 > 职能部门</div>
			<div class="news">
				<ul>
					
					<li><span>[${znbm.subDate}]</span><a href="${pageContext.request.contextPath}/indexRkjsAction!findZnbmForShow?type=0">・办公室职能</a></li>
					<li><span>[${znbm.subDate}]</span><a href="${pageContext.request.contextPath}/indexRkjsAction!findZnbmForShow?type=1">・业务科职能</a></li>
					<li><span>[${znbm.subDate}]</span><a href="${pageContext.request.contextPath}/indexRkjsAction!findZnbmForShow?type=2">・服务站职能</a></li>
