...
<div id="wrap">
	...
	<form action="${pageContext.request.contextPath}/indexRkjsAction!queryLxfsMenu" name="form1"  method="post" ></form>
	...
	<div id="index">
		...
		<div id="sub_R">
			<div class="title5">当前位置 > 人口计生 >联系方式</div>
			<div class="news">
				<ul>
					<s:iterator value="lxfsList" var="list">
					<c:if test="${list.lxfsTitle ne null }">
					<li><span>[${list.subDate}]</span><a href="${pageContext.request.contextPath}/indexRkjsAction!findLxfsForShow?lxfsID=${list.lxfsID}">・${list.lxfsTitle}</a></li>
					</c:if>
					</s:iterator>
				</ul>
				<p class="c"></p>
