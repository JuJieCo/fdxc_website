...
<div id="wrap">
	...
	<form action="${pageContext.request.contextPath}/indexRkjsAction!queryRdgzMenu" name="form1"  method="post" ></form>
	...
	<div id="index">
		...
		<div id="sub_R">
			<div class="title5">当前位置 > 人口计生 > 热点关注</div>
			<div class="news">
				<ul>
					<s:iterator value="rdgzList" var="list">
					<c:if test="${list.rdgzTitle ne null }">
					<li><span>[${list.subDate}]</span><a href="${pageContext.request.contextPath}/indexRkjsAction!findRdgzForShow?rdgzID=${list.rdgzID}">・${list.rdgzTitle}</a></li>
					</c:if>
					</s:iterator>
				</ul>
				<p class="c"></p>
