...
<script type="text/javascript">	
  	function validateForm(){
  		var hdryTitle = document.getElementById('hdryTitle').value;
...
<script type="text/javascript" src="${pageContext.request.contextPath }/uploadify/myuploadify-hdry.js"></script>
...
<form action="${pageContext.request.contextPath}/hdryAction!modifyHdry" id="form1" name="form1" method="post"  enctype="multipart/form-data" onsubmit="return validateForm();" >
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
  ...
  <tr>
    ...
    <input name="hdry.hdryID" type="hidden" value="${hdry.hdryID }">    
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
			...
			<td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" > &nbsp;&nbsp;<input type="text" name="hdry.hdryTitle" value="${hdry.hdryTitle }" size="50" id="hdryTitle"></td>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;
           		<select name="hdry.deptType" >
            		<option value="0"  ${hdry.deptType eq 0 ? "selected":"" }>计卫文体局</option>
            		<option value="1"  ${hdry.deptType eq 1 ? "selected":"" }>人口计生</option>
            		<option value="2"  ${hdry.deptType eq 2 ? "selected":"" }>医疗卫生</option>
            		<option value="3"  ${hdry.deptType eq 3 ? "selected":"" }>文体旅游</option>
            		<option value="4"  ${hdry.deptType eq 4 ? "selected":"" }>食品药品</option>
            	</select>																																	
            </td>
          </tr>
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;<input type="text" name="hdry.subDate"  value="<fmt:formatDate value="${hdry.subDate }" pattern="yyyy-M-d"/>" readonly="readonly" ></td>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;<input type="text" name="hdry.sysUser.loginName" value="${hdry.sysUser.loginName}"   readonly="readonly"  id="loginName">
            																																						   <input type="hidden" name="hdry.sysUser.userID" value="${hdry.sysUser.userID }">
            </td>     	
          ...
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%"  colspan="3">&nbsp;&nbsp;
            	    <textarea id="id_1" name="hdry.hdryContent">${hdry.hdryContent }</textarea> 
