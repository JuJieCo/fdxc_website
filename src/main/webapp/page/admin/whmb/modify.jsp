...
<script type="text/javascript">	
  	function validateForm(){
  		var whmbTitle = document.getElementById('whmbTitle').value;
...
<form action="${pageContext.request.contextPath}/whmbAction!modifyWhmb" id="form1" name="form1" method="post"  enctype="multipart/form-data" onsubmit="return validateForm();" >
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
  ...
  <tr>
    ...
    <input name="whmb.whmbID" type="hidden" value="${whmb.whmbID }">    
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
			...
			<td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%"  colspan="3"> &nbsp;&nbsp;<input type="text" name="whmb.whmbTitle" value="${whmb.whmbTitle }" size="50" id="whmbTitle"></td>
          </tr>
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;<input type="text" name="whmb.subDate"  value="<fmt:formatDate value="${whmb.subDate }" pattern="yyyy-M-d"/>" readonly="readonly" ></td>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;<input type="text" name="whmb.sysUser.loginName" value="${whmb.sysUser.loginName}"   readonly="readonly"  id="loginName">
            																																						   <input type="hidden" name="whmb.sysUser.userID" value="${whmb.sysUser.userID }">
            </td>     	
          ...
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%"  colspan="3">&nbsp;&nbsp;
            	    <textarea id="id_1" name="whmb.whmbContent">${whmb.whmbContent }</textarea> 
