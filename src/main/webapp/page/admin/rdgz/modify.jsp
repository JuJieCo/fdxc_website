...
<script type="text/javascript">	
  	function validateForm(){
  		var rdgzTitle = document.getElementById('rdgzTitle').value;
...
<form action="${pageContext.request.contextPath}/rdgzAction!modifyRdgz" id="form1" name="form1" method="post"  enctype="multipart/form-data" onsubmit="return validateForm();" >
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
  ...
  <tr>
    ...
    <input name="rdgz.rdgzID" type="hidden" value="${rdgz.rdgzID }">    
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
			...
			<td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" > &nbsp;&nbsp;<input type="text" name="rdgz.rdgzTitle" value="${rdgz.rdgzTitle }" size="50" id="rdgzTitle"></td>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;
           		<select name="rdgz.deptType" >
            		<option value="0"  ${rdgz.deptType eq 0 ? "selected":"" }>计卫文体局</option>
            		<option value="1"  ${rdgz.deptType eq 1 ? "selected":"" }>人口计生</option>
            		<option value="2"  ${rdgz.deptType eq 2 ? "selected":"" }>医疗卫生</option>
            		<option value="3"  ${rdgz.deptType eq 3 ? "selected":"" }>文体旅游</option>
            		<option value="4"  ${rdgz.deptType eq 4 ? "selected":"" }>食品药品</option>
            	</select>																																	
            </td>
          </tr>
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;<input type="text" name="rdgz.subDate"  value="<fmt:formatDate value="${rdgz.subDate }" pattern="yyyy-M-d"/>" readonly="readonly" ></td>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;<input type="text" name="rdgz.sysUser.loginName" value="${rdgz.sysUser.loginName}"   readonly="readonly"  id="loginName">
            																																						   <input type="hidden" name="rdgz.sysUser.userID" value="${rdgz.sysUser.userID }">
            </td>     	
          ...
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%"  colspan="3">&nbsp;&nbsp;
            	    <textarea id="id_1" name="rdgz.rdgzContent">${rdgz.rdgzContent }</textarea> 
