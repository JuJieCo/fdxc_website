...
<script type="text/javascript">	
  	function validateForm(){
  		var ndjhTitle = document.getElementById('ndjhTitle').value;
...
<form action="${pageContext.request.contextPath}/ndjhAction!modifyNdjh" id="form1" name="form1" method="post"  enctype="multipart/form-data" onsubmit="return validateForm();" >
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
  ...
  <tr>
    ...
    <input name="ndjh.ndjhID" type="hidden" value="${ndjh.ndjhID }">    
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
			...
			<td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" > &nbsp;&nbsp;<input type="text" name="ndjh.ndjhTitle" value="${ndjh.ndjhTitle }" size="50" id="ndjhTitle"></td>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;
           		<select name="ndjh.deptType" >
            		<option value="0"  ${ndjh.deptType eq 0 ? "selected":"" }>计卫文体局</option>
            		<option value="1"  ${ndjh.deptType eq 1 ? "selected":"" }>人口计生</option>
            		<option value="2"  ${ndjh.deptType eq 2 ? "selected":"" }>医疗卫生</option>
            		<option value="3"  ${ndjh.deptType eq 3 ? "selected":"" }>文体旅游</option>
            		<option value="4"  ${ndjh.deptType eq 4 ? "selected":"" }>食品药品</option>
            	</select>																																	
            </td>
          </tr>
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;<input type="text" name="ndjh.subDate"  value="<fmt:formatDate value="${ndjh.subDate }" pattern="yyyy-M-d"/>" readonly="readonly" ></td>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;<input type="text" name="ndjh.sysUser.loginName" value="${ndjh.sysUser.loginName}"   readonly="readonly"  id="loginName">
            																																						   <input type="hidden" name="ndjh.sysUser.userID" value="${ndjh.sysUser.userID }">
            </td>     	
          ...
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%"  colspan="3">&nbsp;&nbsp;
            	    <textarea id="id_1" name="ndjh.ndjhContent">${ndjh.ndjhContent }</textarea> 
