...
<script type="text/javascript">	
  	function validateForm(){
  		var ldcyTitle = document.getElementById('ldcyTitle').value;
...
<script type="text/javascript" src="${pageContext.request.contextPath }/uploadify/myuploadify-ldcy.js"></script>
...
<form action="${pageContext.request.contextPath}/ldcyAction!modifyLdcy" id="form1" name="form1" method="post"  enctype="multipart/form-data" onsubmit="return validateForm();" >
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
  ...
  <tr>
    ...
    <input name="ldcy.ldcyID" type="hidden" value="${ldcy.ldcyID }">    
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
			...
			<td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" > &nbsp;&nbsp;<input type="text" name="ldcy.ldcyTitle" value="${ldcy.ldcyTitle }" size="50" id="ldcyTitle"></td>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;
           		<select name="ldcy.deptType" >
            		<option value="0"  ${ldcy.deptType eq 0 ? "selected":"" }>计卫文体局</option>
            		<option value="1"  ${ldcy.deptType eq 1 ? "selected":"" }>人口计生</option>
            		<option value="2"  ${ldcy.deptType eq 2 ? "selected":"" }>医疗卫生</option>
            		<option value="3"  ${ldcy.deptType eq 3 ? "selected":"" }>文体旅游</option>
            		<option value="4"  ${ldcy.deptType eq 4 ? "selected":"" }>食品药品</option>
            	</select>																																	
            </td>
          </tr>
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;<input type="text" name="ldcy.subDate"  value="<fmt:formatDate value="${ldcy.subDate }" pattern="yyyy-M-d"/>" readonly="readonly" ></td>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;<input type="text" name="ldcy.sysUser.loginName" value="${ldcy.sysUser.loginName}"   readonly="readonly"  id="loginName">
            																																						   <input type="hidden" name="ldcy.sysUser.userID" value="${ldcy.sysUser.userID }">
            </td>     	
          ...
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%"  colspan="3">&nbsp;&nbsp;
            	    <textarea id="id_1" name="ldcy.ldcyContent">${ldcy.ldcyContent }</textarea> 
