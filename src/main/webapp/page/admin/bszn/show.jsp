	  ...
	  <tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
			...
			<td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" > &nbsp;&nbsp;${bszn.bsznTitle }</td>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;
           		<c:if test="${bszn.deptType eq 0 }">计卫文体局</c:if>
            	<c:if test="${bszn.deptType eq 1 }">人口计生</c:if>
            	<c:if test="${bszn.deptType eq 2 }">医疗卫生</c:if>
            	<c:if test="${bszn.deptType eq 3 }">文体旅游</c:if>
            	<c:if test="${bszn.deptType eq 4 }">食品药品</c:if>																													
            </td>
          </tr>
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;<fmt:formatDate value="${bszn.subDate }" pattern="yyyy-M-d"/></td>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;${bszn.sysUser.loginName}</td>     	
