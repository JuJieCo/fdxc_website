...
<script type="text/javascript">	
  	function validateForm(){
  		var bsznTitle = document.getElementById('bsznTitle').value;
...
<form action="${pageContext.request.contextPath}/bsznAction!modifyBszn" id="form1" name="form1" method="post"  enctype="multipart/form-data" onsubmit="return validateForm();" >
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
  ...
  <tr>
    ...
    <input name="bszn.bsznID" type="hidden" value="${bszn.bsznID }">    
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
			...
			<td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" > &nbsp;&nbsp;<input type="text" name="bszn.bsznTitle" value="${bszn.bsznTitle }" size="50" id="bsznTitle"></td>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;
           		<select name="bszn.deptType" >
            		<option value="0"  ${bszn.deptType eq 0 ? "selected":"" }>计卫文体局</option>
            		<option value="1"  ${bszn.deptType eq 1 ? "selected":"" }>人口计生</option>
            		<option value="2"  ${bszn.deptType eq 2 ? "selected":"" }>医疗卫生</option>
            		<option value="3"  ${bszn.deptType eq 3 ? "selected":"" }>文体旅游</option>
            		<option value="4"  ${bszn.deptType eq 4 ? "selected":"" }>食品药品</option>
            	</select>																																	
            </td>
          </tr>
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;<input type="text" name="bszn.subDate"  value="<fmt:formatDate value="${bszn.subDate }" pattern="yyyy-M-d"/>" readonly="readonly" ></td>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;<input type="text" name="bszn.sysUser.loginName" value="${bszn.sysUser.loginName}"   readonly="readonly"  id="loginName">
            																																						   <input type="hidden" name="bszn.sysUser.userID" value="${bszn.sysUser.userID }">
            </td>     	
          ...
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%"  colspan="3">&nbsp;&nbsp;
            	    <textarea id="id_1" name="bszn.bsznContent">${bszn.bsznContent }</textarea> 
