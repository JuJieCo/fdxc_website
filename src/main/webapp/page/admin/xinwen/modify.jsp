...
<script type="text/javascript">	
  	function validateForm(){
  		var xinwenTitle = document.getElementById('xinwenTitle').value;
  		var loginName =  document.getElementById('loginName').value;
  		var xinwenType = document.getElementById('xinwenType').value;
...
<script type="text/javascript" src="${pageContext.request.contextPath }/uploadify/myuploadify-xinwen.js"></script>
...
<form action="${pageContext.request.contextPath}/xinWenAction!modifyXinWen" id="form1" name="form1" method="post"  enctype="multipart/form-data" onsubmit="return validateForm();" >
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
  ...
  <tr>
    ...
    <input name="xinWen.xinwenID" type="hidden" value="${xinWen.xinwenID }">
	  ...
	  <tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
			...
			<td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" > &nbsp;&nbsp;<input type="text" name="xinWen.xinwenTitle" value="${xinWen.xinwenTitle }" size="50" id="xinwenTitle"></td>
			<td height="22" align="right" bgcolor="#FFFFFF" class="STYLE3" background="${pageContext.request.contextPath}/resource/admin/images/bg.gif" width="10%">新闻类别：</td>
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;<input type="text" name="xinwenType" value="${xinwenType}"  readonly="readonly"  id="xinwenType">
        																																			<input type="hidden" name="xinWen.xinwenType" value="${xinWen.xinwenType}" >			
            </td>
          </tr>
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;<input type="text" name="xinWen.subDate"  value="<fmt:formatDate value="${xinWen.subDate }" pattern="yyyy-M-d"/>" readonly="readonly" ></td>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;
            	<select name="xinWen.deptType" >
            		<option value="0"  ${xinWen.deptType eq 0 ? "selected":"" }>计卫文体局</option>
            		<option value="1"  ${xinWen.deptType eq 1 ? "selected":"" }>人口计生</option>
            		<option value="2"  ${xinWen.deptType eq 2 ? "selected":"" }>医疗卫生</option>
            		<option value="3"  ${xinWen.deptType eq 3 ? "selected":"" }>文体旅游</option>
            		<option value="4"  ${xinWen.deptType eq 4 ? "selected":"" }>食品药品</option>
            	</select>
            </td>
          </tr>
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%"  colspan="3">&nbsp;&nbsp;<input type="text" name="xinWen.sysUser.loginName" value="${xinWen.sysUser.loginName}"   readonly="readonly"  id="loginName">
            																																						   <input type="hidden" name="xinWen.sysUser.userID" value="${xinWen.sysUser.userID }">
            </td>     	
          </tr>
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%"  colspan="3">&nbsp;&nbsp;
            	    <textarea id="id_1" name="xinWen.xinwenContent">${xinWen.xinwenContent }</textarea> 
