...
<script type="text/javascript">	
  	function validateForm(){
  		var wjfbTitle = document.getElementById('wjfbTitle').value;
...
<script type="text/javascript" src="${pageContext.request.contextPath }/uploadify/myuploadify-wjfb.js"></script>
...
<form action="${pageContext.request.contextPath}/wjfbAction!modifyWjfb" id="form1" name="form1" method="post"  enctype="multipart/form-data" onsubmit="return validateForm();" >
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
  ...
  <tr>
    ...
    <input name="wjfb.wjfbID" type="hidden" value="${wjfb.wjfbID }">    
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
			...
			<td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" > &nbsp;&nbsp;<input type="text" name="wjfb.wjfbTitle" value="${wjfb.wjfbTitle }" size="50" id="wjfbTitle"></td>
          ...
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;<input type="text" name="wjfb.subDate"  value="<fmt:formatDate value="${wjfb.subDate }" pattern="yyyy-M-d"/>" readonly="readonly" ></td>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;<input type="text" name="wjfb.sysUser.loginName" value="${wjfb.sysUser.loginName}"   readonly="readonly"  id="loginName">
            																																						   <input type="hidden" name="wjfb.sysUser.userID" value="${wjfb.sysUser.userID }">
            </td>     	
