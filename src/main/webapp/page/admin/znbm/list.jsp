 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
 	<tr height="30">
 		<td width="8"  background="${pageContext.request.contextPath}/resource/admin/images/tab_15.gif">&nbsp;</td>
	  	<td >
			<form action="${pageContext.request.contextPath}/znbmAction!queryZnbmList" name="form1"  method="post" >
 			<s:token name="s_token"></s:token>
	<table width="100%"  bgcolor="#EFF6FE">
	<tr>
		<td class="STYLE4" ></td>
		<td class="STYLE4" >
			单位名称：<input type="text" name="znbm.znbmTitle" value="${znbm.znbmTitle }">
			<input type="hidden" name="znbm.znbmID" value="${znbm.znbmID }">
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
	<tr>
		<td  height="22" align="left" background="${pageContext.request.contextPath}/resource/admin/images/bg.gif" bgcolor="#FFFFFF" width="70%"><span class="STYLE1">&nbsp;&nbsp;单位名称</span></td>
	...
	<!-- 迭代   	-->
	<s:iterator value="znbmList" var="list">
	<c:if test="${list.znbmTitle ne null }">
	<tr>
		<td height="20" bgcolor="#FFFFFF"  align="left" ><span class="STYLE1" >&nbsp;&nbsp;${list.znbmTitle}</span></td>
		<td height="20" bgcolor="#FFFFFF"  align="right" ><span class="STYLE1">${list.subDate}&nbsp;&nbsp;</span></td>
		<td height="20" bgcolor="#FFFFFF"  align="center">
 			<span class="STYLE1"> 
			<a href="${pageContext.request.contextPath}/znbmAction!findZnbmForModify?modify=update&znbmID=${list.znbmID}">修改</a>
			<a href="${pageContext.request.contextPath}/znbmAction!findZnbmForShow?znbmID=${list.znbmID}">查看</a></span>
		</td>
	</tr> 
	</c:if>
	</s:iterator>
