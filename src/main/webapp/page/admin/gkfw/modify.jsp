...
<script type="text/javascript">	
  	function validateForm(){
  		var gkfwTitle = document.getElementById('gkfwTitle').value;
...
<form action="${pageContext.request.contextPath}/gkfwAction!modifyGkfw" id="form1" name="form1" method="post"  enctype="multipart/form-data" onsubmit="return validateForm();" >
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
  ...
  <tr>
    ...
    <input name="gkfw.gkfwID" type="hidden" value="${gkfw.gkfwID }">    
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
			...
			<td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" colspan="3"> &nbsp;&nbsp;<input type="text" name="gkfw.gkfwTitle" value="${gkfw.gkfwTitle }" size="50" id="gkfwTitle"></td>
          </tr>
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;<input type="text" name="gkfw.subDate"  value="<fmt:formatDate value="${gkfw.subDate }" pattern="yyyy-M-d"/>" readonly="readonly" ></td>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;<input type="text" name="gkfw.sysUser.loginName" value="${gkfw.sysUser.loginName}"   readonly="readonly"  id="loginName">
            																																						   <input type="hidden" name="gkfw.sysUser.userID" value="${gkfw.sysUser.userID }">
            </td>     	
          ...
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%"  colspan="3">&nbsp;&nbsp;
            	    <textarea id="id_1" name="gkfw.gkfwContent">${gkfw.gkfwContent }</textarea> 
