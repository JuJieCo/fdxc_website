...
<script type="text/javascript">	
  	function validateForm(){
  		var rsxxTitle = document.getElementById('rsxxTitle').value;
...
<form action="${pageContext.request.contextPath}/rsxxAction!modifyRsxx" id="form1" name="form1" method="post"  enctype="multipart/form-data" onsubmit="return validateForm();" >
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
  ...
  <tr>
    ...
    <input name="rsxx.rsxxID" type="hidden" value="${rsxx.rsxxID }">    
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
			...
			<td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" > &nbsp;&nbsp;<input type="text" name="rsxx.rsxxTitle" value="${rsxx.rsxxTitle }" size="50" id="rsxxTitle"></td>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;
           		<select name="rsxx.deptType" >
            		<option value="0"  ${rsxx.deptType eq 0 ? "selected":"" }>计卫文体局</option>
            		<option value="1"  ${rsxx.deptType eq 1 ? "selected":"" }>人口计生</option>
            		<option value="2"  ${rsxx.deptType eq 2 ? "selected":"" }>医疗卫生</option>
            		<option value="3"  ${rsxx.deptType eq 3 ? "selected":"" }>文体旅游</option>
            		<option value="4"  ${rsxx.deptType eq 4 ? "selected":"" }>食品药品</option>
            	</select>																																	
            </td>
          </tr>
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;<input type="text" name="rsxx.subDate"  value="<fmt:formatDate value="${rsxx.subDate }" pattern="yyyy-M-d"/>" readonly="readonly" ></td>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;<input type="text" name="rsxx.sysUser.loginName" value="${rsxx.sysUser.loginName}"   readonly="readonly"  id="loginName">
            																																						   <input type="hidden" name="rsxx.sysUser.userID" value="${rsxx.sysUser.userID }">
            </td>     	
          ...
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%"  colspan="3">&nbsp;&nbsp;
            	    <textarea id="id_1" name="rsxx.rsxxContent">${rsxx.rsxxContent }</textarea> 
