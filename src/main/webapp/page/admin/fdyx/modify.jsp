...
<script type="text/javascript">	
  	function validateForm(){
  		var fdyxTitle = document.getElementById('fdyxTitle').value;
...
<script type="text/javascript" src="${pageContext.request.contextPath }/uploadify/myuploadify-fdyx.js"></script>
...
<form action="${pageContext.request.contextPath}/fdyxAction!modifyFdyx" id="form1" name="form1" method="post"  enctype="multipart/form-data" onsubmit="return validateForm();" >
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
  ...
  <tr>
    ...
    <input name="fdyx.fdyxID" type="hidden" value="${fdyx.fdyxID }">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
			...
			<td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" > &nbsp;&nbsp;<input type="text" name="fdyx.fdyxTitle" value="${fdyx.fdyxTitle }" size="50" id="fdyxTitle"></td>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;
            	<select name="fdyx.deptType" >
            		<option value="0"  ${fdyx.deptType eq 0 ? "selected":"" }>计卫文体局</option>
            		<option value="1"  ${fdyx.deptType eq 1 ? "selected":"" }>人口计生</option>
            		<option value="2"  ${fdyx.deptType eq 2 ? "selected":"" }>医疗卫生</option>
            		<option value="3"  ${fdyx.deptType eq 3 ? "selected":"" }>文体旅游</option>
            		<option value="4"  ${fdyx.deptType eq 4 ? "selected":"" }>食品药品</option>
            	</select>
            </td>
          </tr>
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;<input type="text" name="fdyx.subDate"  value="<fmt:formatDate value="${fdyx.subDate }" pattern="yyyy-M-d"/>" readonly="readonly" ></td>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%"  colspan="3">&nbsp;&nbsp;<input type="text" name="fdyx.sysUser.loginName" value="${fdyx.sysUser.loginName}"   readonly="readonly"  id="loginName">
            																																						   <input type="hidden" name="fdyx.sysUser.userID" value="${fdyx.sysUser.userID }">
            </td>   
          </tr>
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%"  colspan="3">&nbsp;&nbsp;
            	    <textarea id="id_1" name="fdyx.fdyxContent">${fdyx.fdyxContent }</textarea> 
