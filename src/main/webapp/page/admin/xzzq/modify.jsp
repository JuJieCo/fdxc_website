...
<script type="text/javascript">	
  	function validateForm(){
  		var xzzqTitle = document.getElementById('xzzqTitle').value;
...
<script type="text/javascript" src="${pageContext.request.contextPath }/uploadify/myuploadify-xzzq.js"></script>
...
<form action="${pageContext.request.contextPath}/xzzqAction!modifyXzzq" id="form1" name="form1" method="post"  enctype="multipart/form-data" onsubmit="return validateForm();" >
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
  ...
  <tr>
    ...
    <input name="xzzq.xzzqID" type="hidden" value="${xzzq.xzzqID }">    
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
			...
			<td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" > &nbsp;&nbsp;<input type="text" name="xzzq.xzzqTitle" value="${xzzq.xzzqTitle }" size="50" id="xzzqTitle"></td>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;
           		<select name="xzzq.deptType" >
            		<option value="0"  ${xzzq.deptType eq 0 ? "selected":"" }>计卫文体局</option>
            		<option value="1"  ${xzzq.deptType eq 1 ? "selected":"" }>人口计生</option>
            		<option value="2"  ${xzzq.deptType eq 2 ? "selected":"" }>医疗卫生</option>
            		<option value="3"  ${xzzq.deptType eq 3 ? "selected":"" }>文体旅游</option>
            		<option value="4"  ${xzzq.deptType eq 4 ? "selected":"" }>食品药品</option>
            	</select>																																	
            </td>
          </tr>
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;<input type="text" name="xzzq.subDate"  value="<fmt:formatDate value="${xzzq.subDate }" pattern="yyyy-M-d"/>" readonly="readonly" ></td>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;<input type="text" name="xzzq.sysUser.loginName" value="${xzzq.sysUser.loginName}"   readonly="readonly"  id="loginName">
            																																						   <input type="hidden" name="xzzq.sysUser.userID" value="${xzzq.sysUser.userID }">
            </td>     	
          ...
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%"  colspan="3">&nbsp;&nbsp;
            	    <textarea id="id_1" name="xzzq.xzzqContent">${xzzq.xzzqContent }</textarea> 
          ...
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%"  colspan="3">
           支持格式:xlsx/pptx/docx/xls/ppt/doc/pdf,文件大小小于2MB
