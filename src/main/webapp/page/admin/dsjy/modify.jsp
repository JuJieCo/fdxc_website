...
<script type="text/javascript">	
  	function validateForm(){
  		var dsjyTitle = document.getElementById('dsjyTitle').value;
...
<form action="${pageContext.request.contextPath}/dsjyAction!modifyDsjy" id="form1" name="form1" method="post"  enctype="multipart/form-data" onsubmit="return validateForm();" >
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
  ...
  <tr>
    ...
    <input name="dsjy.dsjyID" type="hidden" value="${dsjy.dsjyID }">    
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
			...
			<td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" colspan="3"> &nbsp;&nbsp;<input type="text" name="dsjy.dsjyTitle" value="${dsjy.dsjyTitle }" size="50" id="dsjyTitle"></td>
          </tr>
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;<input type="text" name="dsjy.subDate"  value="<fmt:formatDate value="${dsjy.subDate }" pattern="yyyy-M-d"/>" readonly="readonly" ></td>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;<input type="text" name="dsjy.sysUser.loginName" value="${dsjy.sysUser.loginName}"   readonly="readonly"  id="loginName">
            																																						   <input type="hidden" name="dsjy.sysUser.userID" value="${dsjy.sysUser.userID }">
            </td>     	
          ...
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%"  colspan="3">&nbsp;&nbsp;
            	    <textarea id="id_1" name="dsjy.dsjyContent">${dsjy.dsjyContent }</textarea> 
