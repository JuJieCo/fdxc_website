 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
 	<tr height="30">
 		<td width="8"  background="${pageContext.request.contextPath}/resource/admin/images/tab_15.gif">&nbsp;</td>
	  	<td >
			<form action="${pageContext.request.contextPath}/dsjyAction!queryDsjyList" name="form1"  method="post" >
 			<s:token name="s_token"></s:token>
	<table width="100%"  bgcolor="#EFF6FE">
	<tr>
		<td class="STYLE4" ></td>
		<td class="STYLE4" >
			标题：<input type="text" name="dsjy.dsjyTitle" value="${dsjy.dsjyTitle }">
			<input type="hidden" name="dsjy.dsjyID" value="${dsjy.dsjyID }">
			<input type="submit" value="查询" name="button">
		</td>
		<td class="STYLE4" ></td>
		<td  class="STYLE4">
			<input type="button" value="新增" name="button" onclick="location.href='${pageContext.request.contextPath}/dsjyAction!findDsjyForModify?modify=save'">
		</td>
	</tr> 
</table>
	 	</form>
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
	...
	<!-- 迭代   	-->
	<s:iterator value="dsjyList" var="list">
	<c:if test="${ list.dsjyTitle ne null }">
	<tr>
		<td height="20" bgcolor="#FFFFFF"  align="left" ><span class="STYLE1" >&nbsp;&nbsp;${list.dsjyTitle}</span></td>
		<td height="20" bgcolor="#FFFFFF"  align="right" ><span class="STYLE1">${list.subDate}&nbsp;&nbsp;</span></td>
		<td height="20" bgcolor="#FFFFFF"  align="center">
 			<span class="STYLE1"> 
			<a href="${pageContext.request.contextPath}/dsjyAction!findDsjyForModify?modify=update&dsjyID=${list.dsjyID}">修改</a>
			<a href="${pageContext.request.contextPath}/dsjyAction!findDsjyForShow?dsjyID=${list.dsjyID}">查看</a>
			<a href="${pageContext.request.contextPath}/dsjyAction!deleteDsjyByID?dsjyID=${list.dsjyID}" onclick="return(confirm('确认要删除吗?'))" >删除</a></span>
		</td>
	</tr> 
	</c:if>
	</s:iterator>
