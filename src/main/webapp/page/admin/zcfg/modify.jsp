...
<script type="text/javascript">	
  	function validateForm(){
  		var zcfgTitle = document.getElementById('zcfgTitle').value;
  		var loginName =  document.getElementById('loginName').value;
  		var zcfgType = document.getElementById('zcfgType').value;
...
<form action="${pageContext.request.contextPath}/zcfgAction!modifyZcfg" id="form1" name="form1" method="post"  enctype="multipart/form-data" onsubmit="return validateForm();" >
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
  ...
  <tr>
    ...
    <input name="zcfg.zcfgID" type="hidden" value="${zcfg.zcfgID }">
	  ...
	  <tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
			...
			<td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" > &nbsp;&nbsp;<input type="text" name="zcfg.zcfgTitle" value="${zcfg.zcfgTitle }" size="50" id="zcfgTitle"></td>
			<td height="22" align="right" bgcolor="#FFFFFF" class="STYLE3" background="${pageContext.request.contextPath}/resource/admin/images/bg.gif" width="10%">法规级别：</td>
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;<input type="text" name="zcfgType" value="${zcfgType}"  readonly="readonly"  id="zcfgType">
        																																			<input type="hidden" name="zcfg.zcfgType" value="${zcfg.zcfgType}" >			
            </td>
          </tr>
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;&nbsp;<input type="text" name="zcfg.subDate"  value="<fmt:formatDate value="${zcfg.subDate }" pattern="yyyy-M-d"/>" readonly="readonly" ></td>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%" >&nbsp;
            	<select name="zcfg.deptType" >
            		<option value="0"  ${zcfg.deptType eq 0 ? "selected":"" }>计卫文体局</option>
            		<option value="1"  ${zcfg.deptType eq 1 ? "selected":"" }>人口计生</option>
            		<option value="2"  ${zcfg.deptType eq 2 ? "selected":"" }>医疗卫生</option>
            		<option value="3"  ${zcfg.deptType eq 3 ? "selected":"" }>文体旅游</option>
            		<option value="4"  ${zcfg.deptType eq 4 ? "selected":"" }>食品药品</option>
            	</select>
            </td>
          </tr>
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%"  colspan="3">&nbsp;&nbsp;<input type="text" name="zcfg.sysUser.loginName" value="${zcfg.sysUser.loginName}"   readonly="readonly"  id="loginName">
            																																						   <input type="hidden" name="zcfg.sysUser.userID" value="${zcfg.sysUser.userID }">
            </td>     	
          </tr>
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="40%"  colspan="3">&nbsp;&nbsp;
            	    <textarea id="id_1" name="zcfg.zcfgContent">${zcfg.zcfgContent }</textarea> 
