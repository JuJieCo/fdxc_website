...
<div id="wrap">
	...
	<form action="${pageContext.request.contextPath}/indexWtlyAction!queryTzggMenu" name="form1"  method="post" ></form>
	...
	<div id="index">
		...
		<div id="sub_R">
			<div class="title5">当前位置 > 文体旅游 > 通知公告</div>
			<div class="news">
				<ul>
					<s:iterator value="tzggList" var="list">
					<c:if test="${list.tzggTitle ne null }">
					<li><span>[${list.subDate}]</span><a href="${pageContext.request.contextPath}/indexWtlyAction!findTzggForShow?tzggID=${list.tzggID}">・${list.tzggTitle}</a></li>
					</c:if>
					</s:iterator>
				</ul>
				<p class="c"></p>
