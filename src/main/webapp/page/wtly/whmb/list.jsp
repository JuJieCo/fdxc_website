...
<div id="wrap">
	...
	<form action="${pageContext.request.contextPath}/indexWtlyAction!queryWhmbMenu" name="form1"  method="post" ></form>
	...
	<div id="index">
		...
		<div id="sub_R">
			<div class="title5">当前位置 > 文体旅游 > 文化漫步</div>
			<div class="news">
				<ul>
					<s:iterator value="whmbList" var="list">
					<c:if test="${list.whmbTitle ne null }">
					<li><span>[${list.subDate}]</span><a href="${pageContext.request.contextPath}/indexWtlyAction!findWhmbForShow?whmbID=${list.whmbID}">・${list.whmbTitle}</a></li>
					</c:if>
					</s:iterator>
				</ul>
				<p class="c"></p>
