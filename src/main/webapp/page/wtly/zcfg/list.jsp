...
<div id="wrap">
	...
	<form action="${pageContext.request.contextPath}/indexWtlyAction!queryZcfgMenu" name="form1"  method="post" ></form>
		...
		<div id="sub_R">
			...
			<div class="news">
				<ul>
					...
					<li><span>[${list.subDate}]</span><a href="${pageContext.request.contextPath}/indexWtlyAction!findZcfgForShow?zcfgID=${list.zcfgID}">・${list.zcfgTitle}</a></li>
					</c:if>
					</s:iterator>
				</ul>
				<p class="c"></p>
