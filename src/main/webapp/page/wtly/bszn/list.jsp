...
<div id="wrap">
	...
	<form action="${pageContext.request.contextPath}/indexWtlyAction!queryBsznMenu" name="form1"  method="post" ></form>
	...
	<div id="index">
		...
		<div id="sub_R">
			<div class="title5">当前位置 > 文体旅游 > 办事指南</div>
			<div class="news">
				<ul>
					<s:iterator value="bsznList" var="list">
					<c:if test="${list.bsznTitle ne null }">
					<li><span>[${list.subDate}]</span><a href="${pageContext.request.contextPath}/indexWtlyAction!findBsznForShow?bsznID=${list.bsznID}">・${list.bsznTitle}</a></li>
					</c:if>
					</s:iterator>
				</ul>
				<p class="c"></p>
