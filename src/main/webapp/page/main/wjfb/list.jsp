...
<div id="top">
	...
	<form action="${pageContext.request.contextPath}/indexAction!queryWjfbMenu" name="form1"  method="post" ></form>
		...
		<div id="sub_R">
			...
			<div class="news">
				<ul>
					...
					<li><span>[${list.subDate}]</span><a href="${pageContext.request.contextPath}/indexAction!findWjfbForShow?wjfbID=${list.wjfbID}">・${list.wjfbTitle}</a></li>
					</c:if>
					</s:iterator>
				</ul>
				<p class="c"></p>
