...
<div id="top">
	...
	<form action="${pageContext.request.contextPath}/indexAction!queryLdcyMenu" name="form1"  method="post" ></form>
...
<div id="banner">
	...
	<div id="index">
		...
		<div id="sub_R">
			<div class="title5">当前位置 > 政务公开 > 领导成员</div>
			<div class="news">
				<ul>
					<s:iterator value="ldcyList" var="list">
					<c:if test="${list.ldcyTitle ne null }">
					<li><span>[${list.subDate}]</span><a href="${pageContext.request.contextPath}/indexAction!findLdcyForShow?ldcyID=${list.ldcyID}">・${list.ldcyTitle}</a></li>
					</c:if>
					</s:iterator>
				</ul>
				<p class="c"></p>
