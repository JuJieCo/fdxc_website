...
<div id="banner">
	...
	<div id="index">
		...
		<div id="sub_R">
			...
			<div class="contant">
				<div class="con_title">
					<h3>${ldcy.ldcyTitle }</h3>
					<p>作者：${ldcy.sysUser.userName }　发布时间：${ldcy.subDate }</p>
				</div>
				<div class="text">
					<c:if test="${ldcy.ldcyFileUrl ne null }">
					<p align="center">
						<img width="146"  height="207"  align="middle"  src="${pageContext.request.contextPath}${ldcy.ldcyFileUrl }">
					</p>
					</c:if>
					<p>&nbsp;</p>
					${ldcy.ldcyContent }
