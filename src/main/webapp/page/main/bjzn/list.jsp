...
<div id="banner">
	...
	<div id="index">
		...
		<div id="sub_R">
			<div class="title5">当前位置 > 机构设置 > 本局职能</div>
			<div class="news">
				<ul>
					<s:iterator value="bjznList" var="list">
					<c:if test="${list.bjznTitle ne null }">
					<li><span>[${list.subDate}]</span><a href="${pageContext.request.contextPath}/indexAction!findBjznForShow?bjznID=${list.bjznID}">・${list.bjznTitle}</a></li>
					</c:if>
					</s:iterator>
				</ul>
				<p class="c"></p>
