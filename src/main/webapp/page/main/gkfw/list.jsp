...
<div id="top">
	...
	<form action="${pageContext.request.contextPath}/indexAction!queryGkfwMenu" name="form1"  method="post" ></form>
...
<div id="banner">
	...
	<div id="index">
		...
		<div id="sub_R">
			<div class="title5">当前位置 >  政务公开 > 公开范围</div>
			<div class="news">
				<ul>
					<s:iterator value="gkfwList" var="list">
					<c:if test="${list.gkfwTitle ne null }">
					<li><span>[${list.subDate}]</span><a href="${pageContext.request.contextPath}/indexAction!findGkfwForShow?gkfwID=${list.gkfwID}">・${list.gkfwTitle}</a></li>
					</c:if>
					</s:iterator>
				</ul>
				<p class="c"></p>
