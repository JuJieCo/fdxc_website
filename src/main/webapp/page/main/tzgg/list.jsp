...
<div id="top">
	...
	<form action="${pageContext.request.contextPath}/indexAction!queryTzggMenu" name="form1"  method="post" ></form>
...
<div id="banner">
	...
	<div id="index">
		...
		<div id="sub_R">
			<div class="title5">当前位置 > 政务公开 > 通知公告</div>
			<div class="news">
				<ul>
					<s:iterator value="tzggList" var="list">
					<c:if test="${list.tzggTitle ne null }">
					<li><span>[${list.subDate}]</span><a href="${pageContext.request.contextPath}/indexAction!findTzggForShow?tzggID=${list.tzggID}">・${list.tzggTitle}</a></li>
					</c:if>
					</s:iterator>
				</ul>
				<p class="c"></p>
