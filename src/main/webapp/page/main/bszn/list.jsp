...
<div id="top">
	...
	<form action="${pageContext.request.contextPath}/indexAction!queryBsznMenu" name="form1"  method="post" ></form>
...
<div id="banner">
	...
	<div id="index">
		<div id="sub_L">
			<div class="title4">办事指南</div>
			<ul>
				<li><a href="${pageContext.request.contextPath}/indexAction!queryBsznMenu">办事指南</a></li>
			</ul>	
		</div>
		<div id="sub_R">
			<div class="title5">当前位置 > 办事指南</div>
			<div class="news">
				<ul>
					<s:iterator value="bsznList" var="list">
					<c:if test="${list.bsznTitle ne null }">
					<li><span>[${list.subDate}]</span><a href="${pageContext.request.contextPath}/indexAction!findBsznForShow?bsznID=${list.bsznID}">・${list.bsznTitle}</a></li>
					</c:if>
					</s:iterator>
				</ul>
				<p class="c"></p>
