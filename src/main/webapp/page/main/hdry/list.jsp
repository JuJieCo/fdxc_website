...
<div id="top">
	...
	<form action="${pageContext.request.contextPath}/indexAction!queryZzjgMenu" name="form1"  method="post" ></form>
...
<div id="banner">
	...
	<div id="index">
		...
		<div id="sub_R">
			<div class="title5">当前位置 > 机构设置 > 获得荣誉</div>
			<div class="news">
				<ul>
					<s:iterator value="hdryList" var="list">
					<c:if test="${list.hdryTitle ne null }">
					<li><span>[${list.subDate}]</span><a href="${pageContext.request.contextPath}/indexAction!findHdryForShow?hdryID=${list.hdryID}">・${list.hdryTitle}</a></li>
					</c:if>
					</s:iterator>
				</ul>
				<p class="c"></p>
