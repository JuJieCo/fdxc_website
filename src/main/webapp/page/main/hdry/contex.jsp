...
<div id="banner">
	...
	<div id="index">
		...
		<div id="sub_R">
			...
			<div class="contant">
				<div class="con_title">
					<h3>${hdry.hdryTitle }</h3>
					<p>作者：${hdry.sysUser.userName }　发布时间：${hdry.subDate }</p>
				</div>
				<div class="text">
					<c:if test="${hdry.hdryFileUrl ne null }">
					<p align="center">
						<img width="300"  height="200"  align="middle" src="${pageContext.request.contextPath}${hdry.hdryFileUrl }">
					</p>
					</c:if>
					<p>&nbsp;</p>
					${hdry.hdryContent } 
