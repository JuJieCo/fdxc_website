...
<div id="top">
	...
	<form action="${pageContext.request.contextPath}/indexAction!queryXinwenMenu?type=${type}" name="form1"  method="post" ></form>
...
<div id="banner">
	...
	<div id="index">
		...
		<div id="sub_R">
			<div class="title5">当前位置 > 新闻中心 > ${tpyeText }</div>
			<div class="news">
				<ul>
					<s:iterator value="xinwenList" var="list">
					<c:if test="${list.xinwenTitle ne null }">
					<li><span>[${list.subDate}]</span><a href="${pageContext.request.contextPath}/indexAction!findXinWenForShow?xinwenID=${list.xinwenID }&type=${type }">・${list.xinwenTitle}</a></li>
					</c:if>
					</s:iterator>
				</ul>
				<p class="c"></p>
