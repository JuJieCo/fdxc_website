...
<div id="banner">
	...
	<div id="index">
		...
		<div id="sub_R">
			...
			<div class="contant">
				<div class="con_title">
					<h3>${xinWen.xinwenTitle }</h3>
					<p>作者：${xinWen.sysUser.userName }　发布时间：${xinWen.subDate }</p>
				</div>
				<div class="text">
					<s:iterator value="xwfjList" var="list">
					<p align="center">
						<img width="400"  height="300" align="middle" src="${pageContext.request.contextPath}${list.xwfjFileUrl }">
					</p>
					</s:iterator>
					<p>&nbsp;</p>
					${xinWen.xinwenContent } 
					<p>&nbsp;</p>
				</div>
				<p class="c"></p>
			</div>
