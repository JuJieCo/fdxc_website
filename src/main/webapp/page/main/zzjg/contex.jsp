...
<div id="banner">
	...
	<div id="index">
		...
		<div id="sub_R">
			...
			<div class="contant">
				<div class="con_title">
					<h3>${zzjg.zzjgTitle }</h3>
					<p>作者：${zzjg.sysUser.userName }　发布时间：${zzjg.subDate }</p>
				</div>
				<div class="text">
					<c:if test="${zzjg.zzjgFileUrl ne null }">
					<p align="center">
						<img width="400"  height="300"  align="middle"  src="${pageContext.request.contextPath}${zzjg.zzjgFileUrl }">
					</p>
					</c:if>
					<p>&nbsp;</p>
					${zzjg.zzjgContent }
