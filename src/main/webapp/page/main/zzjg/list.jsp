...
<div id="banner">
	...
	<div id="index">
		...
		<div id="sub_R">
			<div class="title5">当前位置 > 机构设置 > 组织机构</div>
			<div class="news">
				<ul>
					<s:iterator value="zzjgList" var="list">
					<c:if test="${list.zzjgTitle ne null }">
					<li><span>[${list.subDate}]</span><a href="${pageContext.request.contextPath}/indexAction!findZzjgForShow?zzjgID=${list.zzjgID}">・${list.zzjgTitle}</a></li>
					</c:if>
					</s:iterator>
				</ul>
				<p class="c"></p>
