...
<div id="top">
	...
	<form action="${pageContext.request.contextPath}/indexAction!queryRdgzMenu" name="form1"  method="post" ></form>
...
<div id="banner">
	...
	<div id="index">
		<div id="sub_L">
			<div class="title4">热点关注</div>
			<ul>
				<li><a href="${pageContext.request.contextPath}/indexAction!queryRdgzMenu">热点关注</a></li>
			</ul>	
		</div>
		<div id="sub_R">
			<div class="title5">当前位置 > 热点关注 </div>
			<div class="news">
				<ul>
					<s:iterator value="rdgzList" var="list">
					<li><span>[${list.subDate}]</span><a href="${pageContext.request.contextPath}/indexAction!findRdgzForShow?rdgzID=${list.rdgzID}">・${list.rdgzTitle}</a></li>
					</s:iterator>
				</ul>
				<p class="c"></p>
				&nbsp;
