...
<div id="top">
	...
	<form action="${pageContext.request.contextPath}/indexAction!queryJbfcMenu" name="form1"  method="post" ></form>
...
<div id="banner">
	...
	<div id="index">
		<div id="sub_L">
			<div class="title4">街办风采</div>
			<ul>
				<li><a href="${pageContext.request.contextPath}/indexAction!queryJbfcMenu">街办风采</a></li>
			</ul>	
		</div>
		<div id="sub_R">
			<div class="title5">当前位置 > 街办风采</div>
			<div class="news">
				<ul>
					<s:iterator value="jbfcList" var="list">
					<c:if test="${list.jbfcTitle ne null }">
					<li><span>[${list.subDate}]</span><a href="${pageContext.request.contextPath}/indexAction!findJbfcForShow?jbfcID=${list.jbfcID }">・${list.jbfcTitle}</a></li>
					</c:if>
					</s:iterator>
				</ul>
				<p class="c"></p>
