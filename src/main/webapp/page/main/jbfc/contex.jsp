...
<div id="banner">
	...
	<div id="index">
		...
		<div id="sub_R">
			...
			<div class="contant">
				<div class="con_title">
					<h3>${jbfc.jbfcTitle }</h3>
					<p>作者：${jbfc.sysUser.userName }　发布时间：${jbfc.subDate }</p>
				</div>
				<div class="text">
					<s:iterator value="jbfcList" var="list">
					<p align="center">
						<img width="400"  height="300" align="middle" src="${pageContext.request.contextPath}${list.jbfjFileUrl }">
					</p>
					</s:iterator>
					<p>&nbsp;</p>
					${jbfc.jbfcContent }
