...
<div id="banner">
	...
	<div id="index">
		...
		<div id="sub_R">
			<div class="title5">当前位置 > 机构设置 > 大事记要</div>
			<div class="news">
				<ul>
					<s:iterator value="dsjyList" var="list">
					<c:if test="${list.dsjyTitle ne null }">
					<li><span>[${list.subDate}]</span><a href="${pageContext.request.contextPath}/indexAction!findDsjyForShow?dsjyID=${list.dsjyID}">・${list.dsjyTitle}</a></li>
					</c:if>
					</s:iterator>
				</ul>
				<p class="c"></p>
