...
<div id="top">
	...
	<form action="${pageContext.request.contextPath}/indexAction!queryRsxxMenu" name="form1"  method="post" ></form>
...
<div id="banner">
	...
	<div id="index">
		...
		<div id="sub_R">
			<div class="title5">当前位置 > 政务公开 > 人事信息</div>
			<div class="news">
				<ul>
					<s:iterator value="rsxxList" var="list">
					<c:if test="${list.rsxxTitle ne null }">
					<li><span>[${list.subDate}]</span><a href="${pageContext.request.contextPath}/indexAction!findRsxxForShow?rsxxID=${list.rsxxID}">・${list.rsxxTitle}</a></li>
					</c:if>
					</s:iterator>
				</ul>
				<p class="c"></p>
