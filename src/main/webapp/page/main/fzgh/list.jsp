...
<div id="top">
	...
	<form action="${pageContext.request.contextPath}/indexAction!queryFzghMenu" name="form1"  method="post" ></form>
...
<div id="banner">
	...
	<div id="index">
		...
		<div id="sub_R">
			<div class="title5">当前位置 > 政务公开 > 发展规划</div>
			<div class="news">
				<ul>
					<s:iterator value="fzghList" var="list">
					<c:if test="${list.fzghTitle ne null }">
					<li><span>[${list.subDate}]</span><a href="{pageContext.request.contextPath}/indexAction!findFzghForShow?fzghID=${list.fzghID}">・${list.fzghTitle}</a></li>
					</c:if>
					</s:iterator>
				</ul>
				<p class="c"></p>
