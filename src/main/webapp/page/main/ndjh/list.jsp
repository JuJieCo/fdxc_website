...
<div id="top">
	...
	<form action="${pageContext.request.contextPath}/indexAction!queryNdjhMenu" name="form1"  method="post" ></form>
...
<div id="banner">
	...
	<div id="index">
		...
		<div id="sub_R">
			<div class="title5">当前位置 > 政务公开 > 年度计划</div>
			<div class="news">
				<ul>
					<s:iterator value="ndjhList" var="list">
					<c:if test="${list.ndjhTitle ne null }">
					<li><span>[${list.subDate}]</span><a href="${pageContext.request.contextPath}/indexAction!findNdjhForShow?ndjhID=${list.ndjhID}">・${list.ndjhTitle}</a></li>
					</c:if>
					</s:iterator>
				</ul>
				<p class="c"></p>
