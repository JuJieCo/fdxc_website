...
<div id="banner">
	...
	<div id="index">
		...
		<div id="sub_R">
			...
			<div class="contant">
				<div class="con_title">
					<h3>${fdyx.fdyxTitle }</h3>
					<p>作者：${fdyx.sysUser.userName }　发布时间：${fdyx.subDate }</p>
				</div>
				<div class="text">
					<s:iterator value="fdfjList" var="list">
					<p align="center">
						<img width="400"  height="300" align="middle" src="${pageContext.request.contextPath}${list.fdfjFileUrl }">
					</p>
					</s:iterator>
					<p>&nbsp;</p>
					${fdyx.fdyxContent }
