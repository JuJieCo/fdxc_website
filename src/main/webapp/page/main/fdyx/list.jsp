...
<div id="top">
	...
	<form action="${pageContext.request.contextPath}/indexAction!queryFdyxMenu" name="form1"  method="post" ></form>
...
<div id="banner">
	...
	<div id="index">
		<div id="sub_L">
			<div class="title4">沣东印象</div>
			<ul>
				<li><a href="${pageContext.request.contextPath}/indexAction!queryFdyxMenu">沣东印象</a></li>
			</ul>	
		</div>
		<div id="sub_R">
			<div class="title5">当前位置 > 沣东印象</div>
			<div class="news">
				<ul>
					<s:iterator value="fdyxList" var="list">
					<c:if test="${list.fdyxTitle ne null }">
					<li><span>[${list.subDate}]</span><a href="${pageContext.request.contextPath}/indexAction!findFdyxForShow?fdyxID=${list.fdyxID }">・${list.fdyxTitle}</a></li>
					</c:if>
					</s:iterator>
				</ul>
				<p class="c"></p>
