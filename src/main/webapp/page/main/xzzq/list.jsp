...
<div id="top">
	...
	<form action="${pageContext.request.contextPath}/indexAction!queryXzzqMenu" name="form1"  method="post" ></form>
...
<div id="banner">
	...
	<div id="index">
		<div id="sub_L">
			<div class="title4">下载专区</div>
			<ul>
				<li><a href="${pageContext.request.contextPath}/indexAction!queryXzzqMenu">下载专区</a></li>
			</ul>	
		</div>
		<div id="sub_R">
			<div class="title5">当前位置 > 下载专区</div>
			<div class="news">
				<ul>
					<s:iterator value="xzzqList" var="list">
					<c:if test="${list.xzzqTitle ne null }">
					<li><span>[${list.subDate}]</span><a href="${pageContext.request.contextPath}/indexAction!findXzzqForShow?xzzqID=${list.xzzqID}">・${list.xzzqTitle}</a></li>
					</c:if>
					</s:iterator>
				</ul>
				<p class="c"></p>
