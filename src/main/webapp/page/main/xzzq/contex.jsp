...
<div id="banner">
	...
	<div id="index">
		...
		<div id="sub_R">
			...
			<div class="contant">
				<div class="con_title">
					<h3>${xzzq.xzzqTitle }</h3>
					<p>作者：${xzzq.sysUser.userName }　发布时间：${xzzq.subDate }</p>
				</div>
				<div class="text">
					${xzzq.xzzqContent } 
					<c:if test="${xzzq.xzzqFileUrl ne null }">
					
					附件下载:	<a href="${pageContext.request.contextPath}${xzzq.xzzqFileUrl }">${xzzq.xzzqFileName }</a>
